...
from eis.app.backend import settings
from eis.app.backend.analysis import summarize_checkpoint, summarize_runtime_metadata
from eis.app.backend.analysis_service import AnalysisServiceError, build_analyze_response
...
from eis.app.export.models import ExportOptions
from eis.app.export.writer import build_zip_bytes

logger = logging.getLogger(__name__)
app = FastAPI(
    title="Europa ALM-IS Web API",
    description=(
        "Analyze arithmetic prompts against a checkpoint-backed native PyTorch model. "
        "Returns token-level activations, logits, generated-answer details, and "
        "capability-gated summaries for dashboard rendering."
    ),
)
