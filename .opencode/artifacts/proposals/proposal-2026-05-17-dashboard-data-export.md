...
- Export behavior should respect runtime capabilities: `digit_roles` / native PyTorch lacks raw attention and full network analysis today.
...
- Existing checkpoint compatibility and dual-runtime loading should be preserved.
